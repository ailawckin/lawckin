-- Update lawyer list and search functions to return canonical practice areas and service locations

-- Update get_lawyers_list
    ...
    SELECT
      ...
      (
        ...
        CASE
          ...
          WHEN ld.languages IS NOT NULL AND ld.languages && p_languages THEN 5
          ELSE 0
        END +
