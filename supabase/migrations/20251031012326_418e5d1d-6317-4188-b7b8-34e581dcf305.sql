-- Add time_slot_id to consultations table for bidirectional linking
ALTER TABLE public.consultations 
ADD COLUMN time_slot_id uuid REFERENCES public.time_slots(id);

-- Create index for performance
CREATE INDEX idx_consultations_time_slot_id ON public.consultations(time_slot_id);

-- Update the book_time_slot function to set time_slot_id in consultations
